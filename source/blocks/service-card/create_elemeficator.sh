...
end1
cat service-card.pug >> newFile.pug
mv -f newFile.pug  service-card.pug
...
end3
cat service-card.scss >> newFile.scss
mv -f newFile.scss service-card.scss
cd ${fileName}
