...
end1
cat form-container.pug >> newFile.pug
mv -f newFile.pug  form-container.pug
...
end3
cat form-container.scss >> newFile.scss
mv -f newFile.scss form-container.scss
cd ${fileName}
