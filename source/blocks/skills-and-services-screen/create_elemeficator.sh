#!/bin/sh
parentName=skills-and-services-screen
...
end1
cat skills-and-services-screen.pug >> newFile.pug
mv -f newFile.pug  skills-and-services-screen.pug
...
end3
cat skills-and-services-screen.scss >> newFile.scss
mv -f newFile.scss skills-and-services-screen.scss
cd ${fileName}
