...
end1
cat my-person-screen.pug >> newFile.pug
mv -f newFile.pug  my-person-screen.pug
...
end3
cat my-person-screen.scss >> newFile.scss
mv -f newFile.scss my-person-screen.scss
cd ${fileName}
