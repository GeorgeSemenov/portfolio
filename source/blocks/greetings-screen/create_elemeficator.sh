...
end1
cat greetings-screen.pug >> newFile.pug
mv -f newFile.pug  greetings-screen.pug
...
end3
cat greetings-screen.scss >> newFile.scss
mv -f newFile.scss greetings-screen.scss
cd ${fileName}
