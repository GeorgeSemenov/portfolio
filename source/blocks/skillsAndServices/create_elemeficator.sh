...
end1
cat skillsAndServices.pug >> newFile.pug
mv -f newFile.pug  skillsAndServices.pug
...
end3
cat skillsAndServices.scss >> newFile.scss
mv -f newFile.scss skillsAndServices.scss
cd ${fileName}
