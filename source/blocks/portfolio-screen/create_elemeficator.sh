...
end1
cat portfolio-screen.pug >> newFile.pug
mv -f newFile.pug  portfolio-screen.pug
...
end3
cat portfolio-screen.scss >> newFile.scss
mv -f newFile.scss portfolio-screen.scss
cd ${fileName}
